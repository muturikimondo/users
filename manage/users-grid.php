...
<div class="container-fluid mt-4">
    ...
    <!-- Users Table -->
    <div class="table-responsive glassmorphic p-3 rounded-3">
        <table class="table table-hover align-middle table-striped" id="usersTable">
    ...
    <div id="paginationWrapper" class="mt-3">
        <!-- AJAX-loaded pagination buttons -->
    </div>
</div>
